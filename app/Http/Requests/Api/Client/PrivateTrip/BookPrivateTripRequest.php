...
class BookPrivateTripRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'amenity_ids.array' => __('Amenities must be an array'),
            'amenity_ids.*.exists' => __('Selected amenity does not exist'),
